...
_EVENT_LABELS: dict[str, str] = {
    ...
    "gateway.sandboxes_reaped": "Gateway Restart REAPED Sandboxes",
    "kill_switch.engaged": "Kill Switch ENGAGED",
    "kill_switch.released": "Kill Switch Released",
    "rate.paused": "Rate Governor SOFT-PAUSED",
    "rate.resumed": "Rate Governor Resumed",
...
_NTFY_PRIORITIES: dict[str, int] = {
    ...
    "gateway.recovered": 3,
    "gateway.sandboxes_reaped": 5,
    "kill_switch.engaged": 5,
    "kill_switch.released": 4,
    "rate.paused": 4,
    "rate.resumed": 3,
    "budget.exceeded": 4,
    "node.threshold_breached": 4,
    "node.recovered": 3,
}
...
_NTFY_TAGS: dict[str, str] = {
    ...
    "gateway.sandboxes_reaped": "skull",
    "kill_switch.engaged": "octagonal_sign",
    "kill_switch.released": "arrow_forward",
    "rate.paused": "pause_button",
    "rate.resumed": "arrow_forward",
    "budget.exceeded": "money_with_wings",
    "node.threshold_breached": "thermometer",
    "node.recovered": "white_check_mark",
