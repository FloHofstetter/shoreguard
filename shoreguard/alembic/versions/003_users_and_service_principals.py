...
def upgrade() -> None:
    ...
    op.create_index("ix_service_principals_created_by", "service_principals", ["created_by"])
...
def downgrade() -> None:
    ...
    op.drop_index("ix_service_principals_created_by", table_name="service_principals")
