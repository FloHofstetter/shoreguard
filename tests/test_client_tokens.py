...
class _FakeStub:
    ...
    def IssueSandboxToken(self, req, timeout=None):
        self.requests.append(("issue", req))
        return SimpleNamespace(token="jwt-issue", expires_at_ms=1000)

    def RefreshSandboxToken(self, req, timeout=None):
